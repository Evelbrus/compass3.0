...
export const renderOrdersActions = (entity, uuid, navigate) => (_jsxs("div", { className: "flex", children: [entity === 'orders' && (_jsx("div", { className: "p-2 hover:bg-blue-100 rounded-full flex justify-center items-center cursor-pointer transition-colors duration-300", onClick: () => handleOrderDriverDetail(entity, uuid), children: _jsx(Icon, { name: "view", alt: "\u0420\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C", className: "w-6 h-6 text-blue-500 hover:text-blue-700" }) })), _jsx("div", { className: "p-2 hover:bg-blue-100 rounded-full flex justify-center items-center cursor-pointer transition-colors duration-300", onClick: () => handleEdit(entity, uuid, navigate), children: _jsx(Icon, { name: "edit", alt: "\u0420\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C", className: "w-6 h-6 text-blue-500 hover:text-blue-700" }) }), _jsx("div", { className: "p-2 hover:bg-green-100 rounded-full flex justify-center items-center cursor-pointer transition-colors duration-300", children: _jsx(Icon, { name: "download", alt: "\u0421\u043A\u0430\u0447\u0430\u0442\u044C", className: "relative left-[1.5px] text-green-500 hover:text-green-700" }) }), _jsx("div", { className: "p-2 hover:bg-red-100 rounded-full flex justify-center items-center cursor-pointer transition-colors duration-300", onClick: () => handleDelete(entity, uuid), children: _jsx(Icon, { name: "delete", alt: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C", className: "relative left-[1.5px] w-6 h-6 text-red-500 hover:text-red-700" }) })] }));
