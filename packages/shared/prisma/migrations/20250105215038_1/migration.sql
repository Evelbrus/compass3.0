...
-- CreateEnum
CREATE TYPE "RateType" AS ENUM ('hourly', 'fixed', 'none');
...
-- CreateEnum
CREATE TYPE "ServiceLevels" AS ENUM ('Economy', 'Business', 'VIP');

-- CreateEnum
CREATE TYPE "ClientType" AS ENUM ('Regular', 'Corporate', 'none');

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('Client', 'ClientCorp', 'Driver', 'Operator', 'Admin');
...
-- CreateEnum
CREATE TYPE "VehicleType" AS ENUM ('Coupe', 'Minivan', 'Sedan', 'SUV', 'Hatchback', 'Wagon', 'Van', 'Convertible', 'Pickup', 'Electric', 'Hybrid', 'none');
...
CREATE TABLE "orders" (
    ...
    "tariff_service_id" TEXT NOT NULL,
...
CREATE TABLE "service_levels" (
    "uuid" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "service_type" "ServiceLevels" NOT NULL,
    "price" INTEGER NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "service_levels_pkey" PRIMARY KEY ("uuid")
);
...
-- CreateTable
CREATE TABLE "tariff_on_service_levels" (
    "uuid" TEXT NOT NULL,
    "tariff_uuid" TEXT NOT NULL,
    "service_uuid" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "tariff_on_service_levels_pkey" PRIMARY KEY ("uuid")
);
...
-- CreateTable
CREATE TABLE "vehicle_on_service_levels" (
    "uuid" TEXT NOT NULL,
    ...
    CONSTRAINT "vehicle_on_service_levels_pkey" PRIMARY KEY ("uuid")
);
...
-- AddForeignKey
ALTER TABLE "driver_history" ADD CONSTRAINT "driver_history_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "driver_profile"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "users"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_tariff_id_fkey" FOREIGN KEY ("tariff_id") REFERENCES "tariffs"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_tariff_id_tariff_service_id_fkey" FOREIGN KEY ("tariff_id", "tariff_service_id") REFERENCES "tariff_on_service"("tariff_uuid", "service_uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_departure_point_id_fkey" FOREIGN KEY ("departure_point_id") REFERENCES "points"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_arrival_point_id_fkey" FOREIGN KEY ("arrival_point_id") REFERENCES "points"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_assigned_driver_id_fkey" FOREIGN KEY ("assigned_driver_id") REFERENCES "driver_profile"("uuid") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "order_options" ADD CONSTRAINT "order_options_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "orders"("uuid") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "tariff_on_service" ADD CONSTRAINT "tariff_on_service_tariff_uuid_fkey" FOREIGN KEY ("tariff_uuid") REFERENCES "tariffs"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tariff_on_service" ADD CONSTRAINT "tariff_on_service_service_uuid_fkey" FOREIGN KEY ("service_uuid") REFERENCES "additional_services"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tariff_on_service_levels" ADD CONSTRAINT "tariff_on_service_levels_tariff_uuid_fkey" FOREIGN KEY ("tariff_uuid") REFERENCES "tariffs"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tariff_on_service_levels" ADD CONSTRAINT "tariff_on_service_levels_service_uuid_fkey" FOREIGN KEY ("service_uuid") REFERENCES "service_levels"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "vehicle_on_service_levels" ADD CONSTRAINT "vehicle_on_service_levels_vehicleUuid_fkey" FOREIGN KEY ("vehicleUuid") REFERENCES "vehicles"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vehicle_on_service_levels" ADD CONSTRAINT "vehicle_on_service_levels_serviceUuid_fkey" FOREIGN KEY ("serviceUuid") REFERENCES "service_levels"("uuid") ON DELETE RESTRICT ON UPDATE CASCADE;
