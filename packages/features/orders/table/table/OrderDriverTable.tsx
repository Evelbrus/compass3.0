...
import { ordersDriverColumns } from '@features/orders/table/table/columns/ordersDriverColumns';
...
const OrderTable: React.FC<OrderTableProps> = ({
  ...
  if (loading) return <SkeletonTable columns={ordersDriverColumns} rows={10} />;
