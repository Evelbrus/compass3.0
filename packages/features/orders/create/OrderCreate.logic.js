...
import { useNotifications, useOrderCreateClients, useOrderCreateDrivers, useOrderConfiguration, useOrderCreatePoints, useOrderTime, useOrderCreateAdditionalServices, useOrderPriceCalculation, } from '@features/orders/create/hooks';
import { cleanIntermediatePoints } from '@features/orders/create/helpers';
import { showToast } from '@shared/components/toast/ToastManager';
import { useState, useEffect, useCallback } from 'react';
import { useRouter } from 'next/navigation';
export const useOrderCreateLogic = (uuid) => {
    ...
    const { ...priceCalculation } = useOrderPriceCalculation({
        ...
        selectedIntermediatePoints: points.selectedIntermediatePoints?.filter((point) => point !== null),
    ...
    const handleSuccessCallback = useCallback((res) => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const orderDataToSend = {
                ...
                selectedServices: additionalServices.selectedAdditionalServices.map((service) => service.uuid),
            };
