...
const ClientCorpCreateStep1 = (): JSX.Element => {
  const { control, watch } = useFormContext();
  const password = watch('password');

  return (
    <div className="flex flex-row p-5 justify-center bg-white border rounded-xl">
      <div className="w-2/3 pr-4">
        <h1 className={'text-6 leading-6 mt-4 mb-2 pl-6 font-extrabold'}>
          Создание Корпоративного Клиента - Основная Информация
        </h1>
...
export default ClientCorpCreateStep1;
