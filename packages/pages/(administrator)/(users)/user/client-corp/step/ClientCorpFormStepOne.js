...
const ClientCorpFormStepOne = ({ profilePhotoPath, mode, setPreview, }) => {
    const { control, getValues, clearErrors } = useFormContext();
    return (_jsxs("div", { className: "flex flex-row justify-center", children: [_jsx("div", { className: "w-2/3", children: _jsxs("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4 p-6", children: [_jsx(Controller, { name: "firstName", control: control, defaultValue: "", rules: {
                                required: 'Имя обязательно',
                                validate: (value) => (validateLength(2, 50)(value) && validateNoSpecialChars(value)) ||
                                    'Некорректное имя',
                            }, render: ({ field, fieldState }) => (_jsx(TextInput, { label: "\u0418\u043C\u044F:", type: "text", value: field.value ?? '', onChange: (newValue) => {
                                    clearErrors('firstName');
                                    field.onChange(newValue);
                                }, required: true, error: !!fieldState.error, message: fieldState.error?.message || '' })) }), _jsx(Controller, { name: "lastName", control: control, defaultValue: "", rules: {
                                required: 'Фамилия обязательна',
                                validate: (value) => (validateLength(2, 50)(value) && validateNoSpecialChars(value)) ||
                                    'Некорректная фамилия',
                            }, render: ({ field, fieldState }) => (_jsx(TextInput, { label: "\u0424\u0430\u043C\u0438\u043B\u0438\u044F:", type: "text", value: field.value ?? '', onChange: (newValue) => {
                                    clearErrors('lastName');
                                    field.onChange(newValue);
                                }, required: true, error: !!fieldState.error, message: fieldState.error?.message || '' })) }), _jsx(Controller, { name: "middleName", control: control, defaultValue: "", render: ({ field, fieldState }) => (_jsx(TextInput, { label: "\u041E\u0442\u0447\u0435\u0441\u0442\u0432\u043E:", type: "text", value: field.value ?? '', onChange: (newValue) => {
                                ...
                                validate: validateEmail,
                            }, render: ({ field, fieldState }) => (_jsx(TextInput, { label: "Email:", type: "email", value: field.value ?? '', onChange: (newValue) => {
                                    clearErrors('email');
                                    field.onChange(newValue);
                                }, required: true, error: !!fieldState.error, message: fieldState.error?.message || '' })) }), mode === 'create' && (_jsxs(_Fragment, { children: [_jsx(Controller, { name: "password", control: control, defaultValue: "", rules: {
                                        validate: (value) => validatePassword(value || ''),
                                    }, render: ({ field, fieldState }) => (_jsx(TextInput, { label: "\u041F\u0430\u0440\u043E\u043B\u044C:", type: "password", value: field.value ?? '', onChange: (newValue) => {
                                    ...
                                    }, render: ({ field, fieldState }) => (_jsx(TextInput, { label: "\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u0438\u0435 \u043F\u0430\u0440\u043E\u043B\u044F:", type: "password", value: field.value ?? '', onChange: (newValue) => {
                            ...
                            }, render: ({ field, fieldState }) => (_jsx(PhoneInput, { label: "\u0422\u0435\u043B\u0435\u0444\u043E\u043D:", value: field.value ?? '', onChange: (newValue) => {
                                    clearErrors('phone');
                                    field.onChange(newValue);
