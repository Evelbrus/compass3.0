...
// Иконка автомобиля для уведомлений водителя
const CarIcon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-4 w-4"
  ...
  >
    ...
    <path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1v-1h3.05a2.5 2.5 0 014.9 0H19a1 1 0 001-1v-6a1 1 0 00-.293-.707l-3-3A1 1 0 0016 3H3zm0 1h13v5h-3a1 1 0 00-1 1v3H8v-3a1 1 0 00-1-1H4V5z" />
  </svg>
);

// Цветовая схема для разных типов уведомлений водителя
const DRIVER_NOTIFICATION_COLORS = {
    ...
    <div className="absolute w-[400px] max-h-[600px] right-0 top-10 z-50 bg-gradient-to-br from-white to-gray-50 p-4 flex flex-col gap-2 rounded-lg shadow-xl border border-gray-200 overflow-hidden">
      <div className="flex justify-between items-center mb-2 sticky top-0 bg-white z-10 pb-2 border-b border-gray-100">
        <h1 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-700 to-blue-700">
          ...
          <div className="h-1 w-36 bg-gradient-to-r from-cyan-500 to-transparent rounded-full mt-1"></div>
        </h1>
        <button
          onClick={onClose}
            ...
            <div key={date} className="mb-4">
              ...
              <ul className="space-y-2">
                {groupedNotifications[date].map((notification) => {
                  ...
                  const colorClass =
                    DRIVER_NOTIFICATION_COLORS[actionType] ||
                    DRIVER_NOTIFICATION_COLORS[Action.info];
                  const icon = NOTIFICATION_ICONS[actionType] || NOTIFICATION_ICONS[Action.info];
                  const statusText =
                    DRIVER_STATUS_TEXT[actionType] || DRIVER_STATUS_TEXT[Action.info];
